---
title: Shiny From Scratch Hands on tutorial
...
- tutorial
DisableComments: no
slug: shiny-from-scratch-hands-on-tutorial
tags: 
- shiny
- r
- tutorial 
...
The presentation slides are available [here](https://github.com/Jakob37/ShinyFromScratch/blob/master/presentation.pdf)
...
![](/post/2020-08-18-shiny-from-scratch-hands-on-tutorial.en_files/default_shiny_app.png)
...
![](/post/2020-08-18-shiny-from-scratch-hands-on-tutorial.en_files/ui_server.png)
...
![Basic reactivity](/post/2020-08-18-shiny-from-scratch-hands-on-tutorial.en_files/basic_reactivity.svg)
...
```{r}
data_wide <- read_csv("gapminder_life_expectancy_years.csv")
head(data_wide)
```
...
```{r}
data_long <- read_csv("gapminder_life_expectancy_years_parsed.csv")
head(data_long)
```
...
shinyApp(ui=ui, server=server)
```
![](/post/2020-08-18-shiny-from-scratch-hands-on-tutorial.en_files/ui1.png)
...
shinyApp(ui=ui, server=server)
```
![](/post/2020-08-18-shiny-from-scratch-hands-on-tutorial.en_files/ui2.png)
...
shinyApp(ui=ui, server=server)
```
![](/post/2020-08-18-shiny-from-scratch-hands-on-tutorial.en_files/ui3.png)
...
![](/post/2020-08-18-shiny-from-scratch-hands-on-tutorial.en_files/basic_year_react.svg)
...
shinyApp(ui=ui, server=server)
```
![](/post/2020-08-18-shiny-from-scratch-hands-on-tutorial.en_files/ui4.png)
...
shinyApp(ui=ui, server=server)
```
![](/post/2020-08-18-shiny-from-scratch-hands-on-tutorial.en_files/ui5.png)
...
![Dual plot reactivity](/post/2020-08-18-shiny-from-scratch-hands-on-tutorial.en_files/dual_plot_reactivity.svg)
...
shinyApp(ui=ui, server=server)
```
![](/post/2020-08-18-shiny-from-scratch-hands-on-tutorial.en_files/ui6.png)
...
shinyApp(ui=ui, server=server)
```
![](/post/2020-08-18-shiny-from-scratch-hands-on-tutorial.en_files/ui7.png)
...
shinyApp(ui=ui, server=server)
```
![](/post/2020-08-18-shiny-from-scratch-hands-on-tutorial.en_files/ui8.png)
